        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="p-8 md:p-10 rounded-3xl bg-white border border-gray-200 shadow-sm">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-2xl font-bold text-gray-600">{t('기존: 댓글 기반', 'Legacy: Comment-Based')}</h3>
            </div>
            <ul className="space-y-8">
              <li className="flex gap-4">
                <div className="mt-1 flex-shrink-0"><CheckCircle2 className="w-6 h-6 text-gray-300" /></div>
                <div>
                  <h4 className="text-gray-700 font-semibold text-lg">{t('흔적이 영구적으로 남음', 'Permanent Public Trace')}</h4>
              ...
              <li className="flex gap-4">
                <div className="mt-1 flex-shrink-0"><CheckCircle2 className="w-6 h-6 text-gray-300" /></div>
                <div>
                  <h4 className="text-gray-700 font-semibold text-lg">{t('높은 심리적 저항', 'High Psychological Barrier')}</h4>
              ...
              <li className="flex gap-4">
                <div className="mt-1 flex-shrink-0"><CheckCircle2 className="w-6 h-6 text-gray-300" /></div>
                <div>
                  <h4 className="text-gray-700 font-semibold text-lg">{t('잠수족(Lurker) 90% 이탈', '90% Lurker Drop-Off')}</h4>
