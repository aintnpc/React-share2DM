    ...
    <section className="py-24 bg-gray-50 relative z-10 border-t border-gray-100">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          <div className="hidden md:block absolute top-12 left-[15%] right-[15%] h-[1px] bg-gradient-to-r from-purple-500/0 via-purple-400/40 to-purple-500/0"></div>
          ...
          <div className="relative p-8 rounded-3xl bg-gradient-to-b from-purple-50 to-white border border-purple-200 text-center flex flex-col items-center shadow-[0_0_30px_rgba(147,51,234,0.08)]">
            <div className="w-16 h-16 rounded-2xl bg-purple-100 border border-purple-200 flex items-center justify-center mb-6 relative z-10">
            ...
            <p className="text-purple-700/70 text-sm leading-relaxed">{t('고객이 릴스를 시청하고 브랜드 계정으로 DM 공유 버튼을 누릅니다. (흔적 0%)', 'Customers watch the Reels and tap the DM share button to your brand account. (0% trace)')}</p>
          </div>
