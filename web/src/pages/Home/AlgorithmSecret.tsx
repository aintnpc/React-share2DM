        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
              {t(
                <>고객에게 정보를 주었을 뿐인데, <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">알고리즘 노출</span>이 폭발합니다.</>,
                <>You just shared info with customers, <br />and your <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">algorithm reach</span> explodes.</>
              )}
            </h2>

            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              {t(
                <>인스타그램 릴스 알고리즘의 핵심은 '체류 시간'과 '재공유'입니다. Share2DM을 사용하면 고객이 자연스럽게 릴스를 <strong className="text-white">공유(Send)</strong>하게 유도함으로써, 정보 제공과 동시에 계정의 도달률을 폭발적으로 높이는 <span className="text-white border-b border-purple-500/50 mx-1">일석이조 효과</span>를 누릴 수 있습니다.</>,
                <>The Instagram Reels algorithm prioritizes 'watch time' and 'reshares'. With Share2DM, customers naturally <strong className="text-white">share (Send)</strong> your Reels, giving you a <span className="text-white border-b border-purple-500/50 mx-1">two-in-one effect</span> — delivering info while boosting your reach.</>
              )}
            </p>
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-white font-bold">{t('DM 발송 = 가장 강력한 공유 신호', 'DM Sends = The Strongest Share Signal')}</h4>
