    ...
    <div ref={containerRef} className="relative h-[400vh] bg-white text-gray-900">
      <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none">
          <div className="w-[800px] h-[800px] bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-full blur-[120px] opacity-80"></div>
        </div>
        ...
        <div className={`relative z-10 transition-all duration-700 ease-in-out transform ${step === 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <div className="flex items-center gap-2 px-4 py-1.5 mb-8 text-sm text-purple-600 border rounded-full bg-purple-50 border-purple-200">
        ...
        <div className="relative z-10 w-full max-w-5xl h-[300px] flex items-center justify-center text-center px-4">
          ...
          <div className={`absolute w-full transition-all duration-700 ease-in-out transform ${step === 0 ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 -translate-y-8 scale-95 pointer-events-none'}`}>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-tight text-gray-900">
              {t(
                <>아직도 <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">"댓글"</span> 달아 달라고 하고 <br /> DM을 보내시나요?</>,
                <>Still asking followers to <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">"comment"</span> <br /> before sending a DM?</>
              )}
            </h1>
          </div>
          ...
          <div className={`absolute w-full transition-all duration-700 ease-in-out transform ${step === 2 ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95 pointer-events-none'}`}>
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-gray-900 mb-6">
              {t(
                <>세계최초 <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-indigo-500">공유기반</span> DM자동화<br /> Share2DM</>,
                <>World's First <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-indigo-500">Share-Based</span> DM Automation<br /> Share2DM</>
              )}
            </h1>
